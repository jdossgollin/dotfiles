...
. "$DOTFILES_DIR/install/install-agent-skills.sh"
...
{
    echo "# Auto-generated by dotfiles install.sh — do not edit manually"
    echo "[core]"
    echo "	excludesfile = ~/.gitignore_global"
