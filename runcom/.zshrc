...
# Dotfiles location (avoids forking readlink/which on every shell start)
export DOTFILES_DIR="$HOME/.dotfiles"
if [[ ! -d "$DOTFILES_DIR" ]]; then
    echo "Unable to find dotfiles at $DOTFILES_DIR, exiting."
    return
fi
...
# Skip oh-my-zsh compfix check (must be set BEFORE sourcing oh-my-zsh)
